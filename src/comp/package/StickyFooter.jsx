...
export default function StickyFooter({ home }) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white/95 backdrop-blur-lg">
      <div className="max-w-5xl mx-auto px-5 py-2 flex items-center justify-between">
        ...
        <button className="bg-[#556B2F] hover:bg-[#475b28] transition px-5 py-2.5 rounded-2xl text-white font-semibold flex items-center gap-2">
          Subscribe
          <ArrowRight size={18} />
        </button>
      </div>
