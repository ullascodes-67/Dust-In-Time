          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-gray-500 max-w-xl mx-auto text-base">
                Flexible monthly cleaning subscriptions designed to keep your
                home spotless without the hassle.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6 items-stretch">
              ...
              <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6 hover:-translate-y-1 hover:shadow-xl transition duration-300">
                ...
                <button className="mt-6 w-full border-2 border-[#556B2F] rounded-full py-3 font-semibold text-[#556B2F] hover:bg-[#556B2F] hover:text-white transition">
                  View Details →
                </button>
              </div>
              ...
              <div className="relative rounded-3xl bg-gradient-to-br from-[#6D823B] to-[#556B2F] text-white shadow-xl p-6 overflow-hidden hover:-translate-y-1 transition duration-300">
                ...
                <button className="mt-6 w-full bg-white text-[#556B2F] rounded-full py-3 font-semibold hover:scale-[1.02] transition">
                  View Details →
                </button>
              </div>
            </div>
